...
- (instancetype)safeInitWithObjects:(const id _Nonnull  __unsafe_unretained *)objects count:(NSUInteger)cnt {
    ...
    @catch(NSException *exception) {
        ...
        [AAAppCrashHandle noteErrorWithException:exception defaultToDo:defaultToDo];
...
- (void)safeAddObject:(id)objc {
    ...
    @catch(NSException *exception) {
        ...
        [AAAppCrashHandle noteErrorWithException:exception defaultToDo:message];
    }
    @finally {
...
- (void)safeRemoveObject:(id)obj {
    ...
    @catch (NSException *exception) {
        [AAAppCrashHandle noteErrorWithException:exception defaultToDo:AvoidCrashDefaultIgnore];
    }
    @finally {
