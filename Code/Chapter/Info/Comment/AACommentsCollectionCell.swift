//
//  AACommentsCollectionCell.swift
//  Reader
//
...
import UIKit
 /*
  拉拉
  */
class GDCommentsReplyCollectionCell: MQICollectionViewCell {
...
//                    removeChapterTitle()
    ...
    func addChapterTitle() {
        ...
        self.bringSubview(toFront: chapterTitleLabel)
    }
...
//        54+
        ...
        self.bringSubview(toFront: goodLabel!)
    }
