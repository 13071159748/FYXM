...
class MQIReadCoverView: UIView {
    ...
    func configUI() {
        ...
        self.sendSubviewToBack(bacImageView)
...
//        self.sendSubview(toBack: bookCover)
        ...
        self.bringSubviewToFront(bookName)
        ...
        self.bringSubviewToFront(copyright2)
        ...
        self.bringSubviewToFront(copyright1)
    }
